...
public class InsertServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Employee e = new Employee(id, name, dob, gender, did);
        EmployeeDAO edb = new EmployeeDAO();
        if (edb.insertNewEmployee(e)) {
             response.sendRedirect("/Test1-Search/search");
        } else {
            response.sendRedirect("/Test1-Search/view/insert.jsp");
        }
